...
For each new animal, a first parent needed to be chosen first. A species from which the parent is coming from is sampled randomly (see details later). \
The first parent is then randomly sampled from the sampled species (see details later). \
